...
#landing-title span {
    ...
    opacity: 0;
    /* This is the initial bounce-in animation */
...
/* UPDATED: Start Button Styles */
#start-button {
    background: #E25C6E;
    border: none;
    /* Changed from circle to rounded square */
    border-radius: 25px; 
    width: 80px;
    height: 80px;
    cursor: pointer;
    ...
    justify-content: center;
    align-items: center;
    box-shadow: 0 5px 20px rgba(226, 92, 110, 0.4);
...
#start-button:hover {
    transform: scale(1.1);
    box-shadow: 0 8px 25px rgba(226, 92, 110, 0.6);
}
...
/* NEW: Keyframe animation for the button pulse */
@keyframes pulse {
    0%, 100% {
        transform: scale(1);
        box-shadow: 0 5px 20px rgba(226, 92, 110, 0.4);
